...
public class EsrParsingTests
{
    ...
    public async Task ParseRealEsrRequest_ShouldSucceed()
    {
        ...
        var esrUri = "esr:g2PgYmZgYLjCyJNpw8BknVFSUlBspa-fnKSXmJeckV-kl5OZl61vlGhmmJZkaKFrmZxmomuSZGChm5hiaKxrYWSQZGRgmWZmapnCxAJSepERbhrzpYiPSqIfeNt49ydyv3P92vwo9lQpW8eu_90NQZ5pCYeOLmV0BNvhA7LCWM9Mz0DBqSi_vDi1KKQoMa-4IL-oBCxsqOCbX5WZk5OobwpUohGemZcCVKXgF6JgaKBnYK0AFDAzsVaoMDPRVHAsKMhJDU9N8s4s0Tc1NtczNlPQ8PYI8fXRUcjJzE5VcE9Nzs7XVHDOKMrPTdU3NDHUMwBBheDEtMSiTJgW_4AgfUMjU4gca3FyfkEqR1JOfnaxXmY-AA";
        ...
        Assert.Equal("8fc6dce7942189f842170de953932b1f66693ad3788f766e777b6f9d22335c02", request.ChainId);
    }
    ...
    public async Task ParseWaxIdentityEsr_ShouldSucceed()
    {
        ...
        var esrUri = "esr:g2PgYmZgYLjCyJNpw8BknVFSUlBspa-fnKSXmJeckV-kl5OZl62fZmFsYJhknqxrkWRqomtiaWEAZCVa6pqZJhoYpxokmydZmjGxgJReZESY9lXj3KzTOSJlN34f3uFf3mfrwNS5pGrebk6vArV1xmGxIksZHcF2-ICsMNYz0zNQcCrKLy9OLQopSswrLsgvKgELGyr45ldl5uQk6psClWiEZ-alAFUp-IUoGBroGVgrAAXMTKwVKsxMNBUcCwpyUsNTk7wzS_RNjc31jM0UNLw9Qnx9dBRyMrNTFdxTk7PzNRWcM4ryc1P1DU0M9QxAUCE4MS2xKBOmxT8gSN_QyBQix1qcnF-QypGUk59drJeZDwA";
        ...
        Console.WriteLine($"Has Action: {request.Payload?.Action != null}");
        Console.WriteLine($"Has Transaction: {request.Payload?.Transaction != null}");
        Console.WriteLine($"Is Identity Request: {request.Payload?.Action == null && request.Payload?.Transaction == null}");
        
        // Verify this is WAX mainnet (chain alias 1)
        Assert.Equal("1064487b3cd1a897ce03ae5b6a865651747e2e152090f99c1d19d44e01aea5a4", request.ChainId);
    ...
    public void DebugDecompressEsr()
    {
        ...
        var esrData = "g2PgYmZgYLjCyJNpw8BknVFSUlBspa-fnKSXmJeckV-kl5OZl61vlGhmmJZkaKFrmZxmomuSZGChm5hiaKxrYWSQZGRgmWZmapnCxAJSepERbhrzpYiPSqIfeNt49ydyv3P92vwo9lQpW8eu_90NQZ5pCYeOLmV0BNvhA7LCWM9Mz0DBqSi_vDi1KKQoMa-4IL-oBCxsqOCbX5WZk5OobwpUohGemZcCVKXgF6JgaKBnYK0AFDAzsVaoMDPRVHAsKMhJDU9N8s4s0Tc1NtczNlPQ8PYI8fXRUcjJzE5VcE9Nzs7XVHDOKMrPTdU3NDHUMwBBheDEtMSiTJgW_4AgfUMjU4gca3FyfkEqR1JOfnaxXmY-AA";
        ...
        Console.WriteLine($"First 16 bytes: {BitConverter.ToString(bytes.Take(16).ToArray())}");
        ...
        if (isCompressed)
        {
            ...
            Console.WriteLine($"First bytes of compressed: 0x{compressedData[0]:X2} 0x{compressedData[1]:X2}");
            ...
            Console.WriteLine($"First 64 bytes decompressed: {BitConverter.ToString(decompressed.Take(64).ToArray())}");
            ...
            var callback = System.Text.Encoding.UTF8.GetString(decompressed, callbackStart + 1, callbackLen);
            ...
            else if (chainIdType == 1)
            {
                ...
                var chainId = BitConverter.ToString(decompressed.Skip(1).Take(32).ToArray()).Replace("-", "").ToLowerInvariant();
